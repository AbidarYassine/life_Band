...
public class SignUp extends AppCompatActivity {
    ...
    // Declare variables.
    EditText PasswordText,EmailText,NameText,AgeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AgeText = findViewById(R.id.age_signup);
            ...
            databaseAuth.createUserWithEmailAndPassword(emailDB,passwordDB).addOnCompleteListener(task -> {
                if(task.isSuccessful()){
                    ...
                    documentReference.set(Guardian).addOnSuccessListener(aVoid ->
                            Log.d("TAG","onSuccess : user is created for"+ GuardiansID)).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Log.d(TAG, "onFailure:user is NOT created  " + e.toString());
                        }
                    });
